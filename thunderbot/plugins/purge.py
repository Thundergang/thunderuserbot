...
from thunderbot import BOTLOG, BOTLOG_CHATID, CMD_HELP, PRIVATE_GROUP_ID
...
@thunderbot.on(admin_cmd(outgoing=True, pattern="purgeme"))
@errors_handler
...
@thunderbot.on(admin_cmd(outgoing=True, pattern="del"))
@errors_handler
...
@thunderbot.on(admin_cmd(outgoing=True, pattern="edit"))
@errors_handler
...
@thunderbot.on(admin_cmd(outgoing=True, pattern="sd"))
@errors_handler
