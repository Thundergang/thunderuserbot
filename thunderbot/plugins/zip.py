...
@thunderbot.on(admin_cmd(pattern="zip"))
@thunderbot.on(sudo_cmd(pattern="zip", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@thunderbot.on(admin_cmd(pattern="unzip"))
@thunderbot.on(sudo_cmd(pattern="unzip", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await eor(event, "Processing ...")
