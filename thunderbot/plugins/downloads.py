...
from thunderbot.utils import admin_cmd, humanbytes, time_formatter
...
@thunderbot.on(admin_cmd(pattern=f"gdl", outgoing=True))
@thunderbot.on(sudo_cmd(pattern=f"gdl", allow_sudo=True))
...
@thunderbot.on(admin_cmd(outgoing=True, pattern=r"mega(?: |$)(.*)"))
