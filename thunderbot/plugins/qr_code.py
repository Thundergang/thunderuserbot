...
@thunderbot.on(admin_cmd(pattern="getqr"))
@thunderbot.on(sudo_cmd(pattern="getqr", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@thunderbot.on(admin_cmd(pattern="makeqr ?(.*)"))
@thunderbot.on(sudo_cmd(pattern="makeqr ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
