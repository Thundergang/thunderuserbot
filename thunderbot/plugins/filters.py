...
from thunderbot.plugins.sql_helper.filter_sql import (
    add_filter,
    get_all_filters,
    remove_all_filters,
    remove_filter,
...
@thunderbot.on(admin_cmd(pattern="savefilter (.*)"))
@thunderbot.on(sudo_cmd(pattern="savefilter (.*)", allow_sudo=True))
...
@thunderbot.on(admin_cmd(pattern="listfilters"))
@thunderbot.on(sudo_cmd(pattern="listfilters", allow_sudo=True))
...
@thunderbot.on(admin_cmd(pattern="clearfilter (.*)"))
@thunderbot.on(sudo_cmd(pattern="clearfilter (.*)", allow_sudo=True))
...
@thunderbot.on(admin_cmd(pattern="clearallfilters"))
@thunderbot.on(sudo_cmd(pattern="clearallfilters", allow_sudo=True))
