...
@thunderbot.on(admin_cmd(outgoing=True, pattern="setgpic"))
@thunderbot.on(sudo_cmd(outgoing=True, pattern="setgpic", allow_sudo=True))
@errors_handler
...
@thunderbot.on(admin_cmd("promote(?: |$)(.*)"))
@thunderbot.on(sudo_cmd(pattern="promote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@thunderbot.on(admin_cmd(outgoing=True, pattern="demote(?: |$)(.*)"))
@thunderbot.on(sudo_cmd(pattern="demote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@thunderbot.on(admin_cmd(pattern="(ban|unban) ?(.*)"))
@thunderbot.on(sudo_cmd(pattern="(ban|unban) ?(.*)", allow_sudo=True))
async def _(event):
...
@thunderbot.on(admin_cmd(pattern="pgs ?(.*)"))
@thunderbot.on(sudo_cmd(pattern="pgs ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@thunderbot.on(admin_cmd(outgoing=True, pattern="admins$"))
@errors_handler
...
@thunderbot.on(admin_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@thunderbot.on(sudo_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@errors_handler
async def pin(msg):
...
@thunderbot.on(admin_cmd(outgoing=True, pattern="kick(?: |$)(.*)"))
@thunderbot.on(sudo_cmd(outgoing=True, pattern="kick(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def kick(usr):
...
@thunderbot.on(admin_cmd(outgoing=True, pattern="users ?(.*)"))
@errors_handler
