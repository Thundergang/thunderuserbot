...
@thunderbot.on(admin_cmd(pattern="get_ad?(m)in ?(.*)"))
@thunderbot.on(sudo_cmd(pattern="get_ad?(m)in ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@thunderbot.on(admin_cmd(pattern="get_id"))
@thunderbot.on(sudo_cmd(pattern="get_id", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.reply_to_msg_id:
...
@thunderbot.on(admin_cmd(pattern="get_bot ?(.*)"))
@thunderbot.on(sudo_cmd(pattern="get_bot ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
