...
import thunderbot.plugins.sql_helper.blacklist_sql as sql
...
@thunderbot.on(admin_cmd(pattern="listblacklist"))
@thunderbot.on(sudo_cmd(pattern="listblacklist"))
...
@thunderbot.on(admin_cmd(pattern="rmblacklist ((.|\n)*)"))
@thunderbot.on(sudo_cmd(pattern="rmblacklist ((.|\n)*)"))
