...
from thunderbot import TEMP_DOWNLOAD_DIRECTORY, TELEGRAPH_SHORT_NAME, UB_BLACK_LIST_CHAT, TG_BOT_USER_NAME_BF_HER
...
afk_start = {}
BOTLOG = True
CUSTOM_AFK = os.environ.get("CUSTOM_AFK", "My master is currently unavailable!")
botname = TG_BOT_USER_NAME_BF_HER
...
async def on_afk(event):
    ...
    if USER_AFK and not (await event.get_sender()).bot:
        ...
        if event.chat_id not in UB_BLACK_LIST_CHAT:
